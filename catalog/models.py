...
class Book(models.Model):
    ...
    genre = models.ManyToManyField('Genre', help_text='Set genre for this book')
    ...
    class Meta:
        permissions = (('can_edit_book', 'Can edit books'),)
...
class Author(models.Model):
    ...
    class Meta:
        ...
        permissions = (('can_edit_author', 'Can edit authors'),)
